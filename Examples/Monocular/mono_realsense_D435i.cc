...
int main(int argc, char **argv) {
...
#else
            std::chrono::time_point time_Start_Process = std::chrono::now();
#endif
    ...
    #else
            std::chrono::time_point t_Start_Resize = std::chrono::now();
    #endif
#endif
    ...
    #else
            std::chrono::time_point t_End_Resize = std::chrono::now();
    #endif
    ...
    #else
        std::chrono::time_point t_Start_Track = std::chrono::now();
    #endif
#endif
    ...
    #else
        std::chrono::time_point t_End_Track = std::chrono::now();
    #endif
